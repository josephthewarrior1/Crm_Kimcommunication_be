...
public class DataInitializer {
    ...
    CommandLineRunner seedData(ProjectRepository projects,
        ...
        return args -> {
            ...
            AppUser andiU = users.findByEmail("andi.pratama@kim.co.id").orElseGet(() -> users.save(AppUser.builder()
                    .name("Andi Pratama")
                    .email("andi.pratama@kim.co.id")
                    .username("andi")
                    ...
                    .approved(true)
                    .build()));
            AppUser sitiU = users.findByEmail("siti.rahma@kim.co.id").orElseGet(() -> users.save(AppUser.builder()
                    .name("Siti Rahma")
                    .email("siti.rahma@kim.co.id")
                    .username("siti")
                    .passwordHash(encoder.encode("password"))
                    ...
                    .approved(true)
                    .build()));
            AppUser bagusU = users.findByEmail("bagus.wijaya@kim.co.id").orElseGet(() -> users.save(AppUser.builder()
                    .name("Bagus Wijaya")
                    .email("bagus.wijaya@kim.co.id")
                    .username("bagus")
                    .passwordHash(encoder.encode("password"))
